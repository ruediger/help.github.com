...
You may need to do this for many branches if the remote repo has more than one branch that was pushed by egit.  After you've pushed, testing the repo repo is just a matter of cloning it:
