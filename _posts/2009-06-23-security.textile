...
We're extremely concerned and active about security, but we're aware that many companies are not comfortable putting their code under someone else's control.  For these companies we offer "GitHub:FI":http://fi.github.com/, a version of GitHub that can be installed to a server within the company's network.